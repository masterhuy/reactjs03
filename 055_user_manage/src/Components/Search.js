...
class Search extends Component {
    ...
    hienThiNut= () => {
        if(this.props.hienThiForm === true){
            return <div className="col-2 btn btn-block btn-outline-secondary" onClick={() => this.props.ketNoi()}>Dong lai</div>
        }
        else{
            return <div className="col-2 btn btn-block btn-outline-info" onClick={() => this.props.ketNoi()}>Them moi</div>
        }
    }
